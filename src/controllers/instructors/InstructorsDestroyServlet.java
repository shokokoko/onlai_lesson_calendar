...
/**
 * Servlet implementation class InstructorsDestroyServlet
 */
@WebServlet("/instructors/destroy")
public class InstructorsDestroyServlet extends HttpServlet {
    private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public InstructorsDestroyServlet() {
        super();
